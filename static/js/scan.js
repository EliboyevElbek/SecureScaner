...
function startScan() {
    ...
    showScanProgress(domains.length);
...
function showScanProgress(totalDomains) {
    // Create progress overlay
    const progressOverlay = document.createElement('div');
    progressOverlay.id = 'scanProgressOverlay';
    progressOverlay.className = 'scan-progress-overlay';
    progressOverlay.innerHTML = `
        <div class="scan-progress-content">
            <div class="progress-header">
                <h3>🚀 Parallel Domain Tahlil</h3>
                <p>${totalDomains} ta domain parallel ravishda tahlil qilinmoqda...</p>
            </div>
            
            <div class="progress-stats">
                <div class="stat-item">
                    <span class="stat-label">Jami Domainlar:</span>
                    <span class="stat-value">${totalDomains}</span>
                </div>
                <div class="stat-item">
                    <span class="stat-label">Parallel Tool'lar:</span>
                    <span class="stat-value">4 ta</span>
                </div>
                <div class="stat-item">
                    <span class="stat-label">Taxminiy Vaqt:</span>
                    <span class="stat-value">2-5 daqiqa</span>
                </div>
            </div>
            ...
            <div class="tools-progress">
                ...
                <div class="tool-progress-item">
                    <span class="tool-name">🌐 Nmap (Port & Vulnerability)</span>
                    <span class="tool-status">⏳ Jarayonda...</span>
                </div>
                <div class="tool-progress-item">
                    <span class="tool-name">💉 SQLMap (SQL Injection)</span>
                    <span class="tool-status">⏳ Jarayonda...</span>
                </div>
                <div class="tool-progress-item">
                    <span class="tool-name">📁 Gobuster (Directory)</span>
                    <span class="tool-status">⏳ Jarayonda...</span>
                </div>
                <div class="tool-progress-item">
                    <span class="tool-name">🕷️ XSStrike (XSS)</span>
                    <span class="tool-status">⏳ Jarayonda...</span>
                </div>
            </div>
            
            <div class="progress-note">
                <p>💡 <strong>Parallel scanning:</strong> Barcha domainlar va tool'lar bir vaqtda ishlaydi, 
                bu tahlil vaqtini sezilarli darajada kamaytiradi.</p>
            </div>
        </div>
    `;
    ...
    setTimeout(() => {
        ...
        progressOverlay.style.transform = 'scale(1)';
    }, 10);
}
...
function hideScanProgress() {
    ...
    if (progressOverlay) {
        ...
        progressOverlay.style.transform = 'scale(0.9)';
        setTimeout(() => {
